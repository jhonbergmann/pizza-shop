...
export function PopularProductsChart() {
  const {data: popularProducts, isFetching: isLoadingPopularProducts} = useQuery({
      ...
      <CardHeader className="pb-8">
        <div className="flex flex-row items-center justify-between">
          <CardTitle className="flex items-center gap-2 text-base font-medium">
            Produtos populares
            {isLoadingPopularProducts && <Loader2 className="h-4 w-4 animate-spin text-muted-foreground" />}
          </CardTitle>
