...
export function SignUp() {
  ...
  async function handleRegisteRestaurant({restaurantName, managerName, email, phone}: SignUpSchema) {
    try {
          ...
          <form onSubmit={handleSubmit(handleRegisteRestaurant)}>
            <div className="grid gap-4">
              ...
              <div className="grid gap-2">
                ...
                <Input id="managerName" type="text" autoCorrect="off" {...register('managerName')} />
              </div>
