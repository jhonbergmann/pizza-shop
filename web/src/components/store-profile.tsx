...
export function StoreProfile() {
  ...
  async function handleUpdateProfile({name, description}: StoreProfileSchema) {
    try {
      ...
      <form onSubmit={handleSubmit(handleUpdateProfile)}>
        <div className="grid gap-4 py-4">
          <div className="grid grid-cols-4 items-center gap-4">
            ...
            <Input id="name" className="col-span-3" disabled={isLoadingStoreProfile} {...register('name')} />
          </div>
        ...
        <DialogFooter>
          ...
          <Button type="submit" variant="success" disabled={isLoadingStoreProfile || isSubmitting}>
            Salvar
          </Button>
        </DialogFooter>
      </form>
